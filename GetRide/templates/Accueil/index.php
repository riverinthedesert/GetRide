...
<div class="container">
	<div class="text-center">
		...
		<a href="#" class="btn btn-default btn-lg " role="button" aria-disabled="true"><?php echo $this->Html->image('AjoutPublique.jpg', ['alt' => 'AjoutPublic']); ?><font size="5">Proposer une nouvelle offre de trajet publique</font></a> <br><br>
		<a href="#" class="btn btn-default btn-lg " role="button" aria-disabled="true"><?php echo $this->Html->image('AjoutPrivée.jpg', ['alt' => 'AjoutPrivee']); ?><font size="5">Proposer une nouvelle offre de trajet privée</font></a>
	</div>
	<br>
	<div class="container">
        <div class="row">
            <div class="col-sm-4">
                ...
                <p><br><a href="#"><span class="glyphicon glyphicon-plus"></span> Ajoutez une offre publique</a> avec toutes vos informations de voyage et les conditions de voyage. Ensuite attendez.</p>
                <p><br><span class="glyphicon glyphicon-eye-open"></span> Vérifiez vous mail et vos <a href="#">notifications</a> sur le site, si quelqu'un est interressé par votre annonce, vous serez signalé
            ...
            <div class="col-sm-4">
                ...
                <p><br><a href="#"><span class="glyphicon glyphicon-search"></span> Recherchez une offre publique</a>. Filtrez les offres et signalez votre intérêt. Ensuite attendez que votre demande soit validée.</p>
            ...
            <div class="col-sm-4">
                ...
                <p><br><a href="#"><span class="glyphicon glyphicon-plus"></span> Ajoutez une offre privée</a>, choisissez le groupe de personne à qui envoyer la demande. Et patientez.</p>
                <p><br><span class="glyphicon glyphicon-eye-open"></span> Vérifiez vous mail et vos  <a href="#">notifications</a> sur le site, si quelqu'un est interressé par votre annonce, vous serez signalé.</p>
                <p><br><span class="glyphicon glyphicon-ok"></span> Et voilà ! Le tour est joué.</p>
            </div>
        </div>
    </div>
